...
router.post('/',
  ...
  async(req, res) => {
    ...
    try {
      ...
      const {getSBC, getFreeswitch, incrementFreeswitchCalls, decrementFreeswitchCalls} = srf.locals;
      ...
      try {
        const dlg = await srf.createUAC(uri, {...opts,  followRedirects: true, keepUriOnRedirect: true}, {
          ...
          */
            ...
            void incrementFreeswitchCalls(ms);
        ...
        await decrementFreeswitchCalls(ms);
